...
from search_runtime.events import Event, canonical
...
class TranslatedAgent:
    def __init__(self, store, mode="rules", vectors=None, threshold=0.65):
        from search_runtime.protocol import ProtocolGuard
    ...
    def reset(self, sid, profile):
        ...
        from search_runtime.intent import ShoppingState
    ...
    def _respond(self, sid, text, turn, top_k):
        ...
        from search_runtime.intent import parse, accepts
